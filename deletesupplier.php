...
$sql_min="SELECT MIN(id) from supplier";
...
#button{
    ...
    <div class="display_content">
                ...
                <form action="update_supplier.php" method="POST">
                    ...
                    <table align="center">
                        <caption align='center' style='color:#2E4372'><h3><u>Supplier Name </u></h3></caption>
                        <th>Id</th>
                        <th>Name</th>
                        <?php
                        while($rws=  mysql_fetch_array($result)){
                            echo "<tr><td><input type='radio' name='supplier_id' value=".$rws[0];
